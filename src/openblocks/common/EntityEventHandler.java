...
public class EntityEventHandler {
	...
	public void onEntityJoinWorld(EntityJoinWorldEvent event) {
		...
		if (!event.world.isRemote && entity instanceof EntityPlayer) {
			...
			boolean shouldGiveManual = OpenBlocks.Items.infoBook != null && Config.giveInfoBook && !persistTag.getBoolean(GIVEN_MANUAL_TAG);
			if (shouldGiveManual) {
			...
			boolean shouldGiveChangelog = OpenBlocks.changeLog != null && Config.givechangeLogBook && !persistTag.getString(LATEST_CHANGELOG_TAG).equals(ModInfo.VERSION);
